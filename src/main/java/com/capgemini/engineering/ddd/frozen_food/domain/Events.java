...
public class Events implements ApplicationContextAware {
    ...
    public static <T extends DomainEvent> void report(T event){
        //TODO code to implement a com.capgemini.engineering.ddd.frozen_food.domain.com.capgemini.engineering.ddd.frozen_food.domain._shared.producao.event dispatch on Spring
    }
