...
import com.capgemini.engineering.ddd.frozen_food.domain.sales.domain.exception.ProductionOrderContainsNoItemException;
...
public class ProductionOrderServiceImpl {
    ...
    public ProductionOrder createProductionOrder(@NotNull ProductionOrder productionOrder) {
        ...
        if (this.validateItemsOrderedMap(productionOrder.getItemsOrdered())) {
