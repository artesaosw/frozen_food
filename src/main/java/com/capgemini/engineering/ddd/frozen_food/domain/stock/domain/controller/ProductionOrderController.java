...
public class ProductionOrderController {
    ...
    public ResponseEntity<?> getChefOrderById(@PathVariable @Valid ProductionOrderID id) {
        try {
            var productionOrder = productionOrdersService.getProductionOrderById(id);
    ...
    public ResponseEntity<?> getAllProductionOrders() {
        try {
            return ResponseEntity.ok(productionOrdersService.getAllProductionOrders());
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).contentType(MediaType.TEXT_PLAIN).body(GENERAL_ERROR_MSG);
        }
    }
    ...
    public ResponseEntity<?> getAllDeliveredProductionOrders() {
        try {
            return ResponseEntity.ok(productionOrdersService.getAllProductionOrdersByOrderStatus(OrderStatus.DELIVERED));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).contentType(MediaType.TEXT_PLAIN).body(GENERAL_ERROR_MSG);
        }
    }
    ...
    public ResponseEntity<?> getAllUndeliveredProductionOrders() {
        try {
            return ResponseEntity.ok(productionOrdersService.getAllProductionOrdersByOrderStatus(OrderStatus.UNDELIVERED));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).contentType(MediaType.TEXT_PLAIN).body(GENERAL_ERROR_MSG);
        }
    }
    ...
    public ResponseEntity<?> getAllCanceledProductionOrders() {
        try {
            return ResponseEntity.ok(productionOrdersService.getAllProductionOrdersByOrderStatus(OrderStatus.CANCELED));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).contentType(MediaType.TEXT_PLAIN).body(GENERAL_ERROR_MSG);
        }
    }
    ...
    public ResponseEntity<?> addProductionOrder(@RequestBody @Valid @NotNull ProductionOrder productionOrder) {
        try {
            productionOrdersService.registerNewProductionOrder(productionOrder);
    ...
    public ResponseEntity<?> updateProductionOrder(@RequestBody @Valid @NotNull ProductionOrder productionOrder) {
        try {
            productionOrdersService.updateProductionOrder(productionOrder);
    ...
    public ResponseEntity<?> updateProductionOrderStatus(@PathVariable @Valid @NotNull ProductionOrderID productionOrderID, @RequestParam @Valid @NotNull OrderStatus orderStatus) {
        try {
            productionOrdersService.updateProductionOrderStatus(productionOrderID, orderStatus);
            return ResponseEntity.ok(UPDATE_SUCCESS_MSG);
        } catch (NonExistentIngredientException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).contentType(MediaType.TEXT_PLAIN).body(ORDER_NOT_FOUND_ERROR_MSG);
        }catch (Exception e) {
    ...
    public ResponseEntity<?> deleteProductionOrder(@PathVariable @Valid ProductionOrderID id) {
        try {
            productionOrdersService.deleteProductionOrder(id);
